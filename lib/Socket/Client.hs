...
module Socket.Client (Connection(..), ConnAction(..), apply, getSock, getNextPacketId, getConn, returnIO, chainM) where
...
data Connection = Conn {sock :: S.Socket, nextPacketId :: PacketIdCounter}
